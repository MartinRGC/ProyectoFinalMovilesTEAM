...
class RepartiAdapter (private var repartList: List<LRepartidorModel>):
    ...
    override fun onBindViewHolder(holder: RepartiViewHolder, position: Int) {
        ...
        holder.nombreRepartiTV.text = currentRepar.nombre
        holder.apellidoRepaTV.text = currentRepar.apellido
        holder.ciudadRepaTV.text = currentRepar.ciudad
        holder.numeroRepaTV.text = currentRepar.numero
        holder.correoRepaTV.text = currentRepar.correo
    }
